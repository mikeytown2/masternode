...
# Run this file
# bash -i <(wget -4qO- -o- https://gist.githubusercontent.com/mikeytown2/5ce58af9fbfbcbd2e456e44e9ad66ad3/raw/catocoind.sh) ; source ~/.bashrc
# if skip_last_confirm is set use bash -c instead of bash -ic
# bash -ic "$(wget -4qO- -o- goo.gl/b8VEKj)" -- starting_username_number txhash outputindex genkey skip_last_confirm ; source ~/.bashrc
# screen -d -m bash -c "$(wget -4qO- -o- goo.gl/b8VEKj)" -- -1 0 -1 -1 Y ; source ~/.bashrc
